...
exports.image = function () {
	...
	console.log("  mdk image resize-pixels $size $path");
};
...
exports.video = function () {
	...
	console.log("  mdk video convert $type $path");
	console.log("  mdk video gifify $path");
	console.log("  mdk video resize $size $path");
	console.log("  mdk video resize-pixels $size $path");
};

exports.videoCompress = function () {
	console.log("- video compress example:");
	console.log("  mdk video compress *.mov");
};

exports.videoConvert = function () {
	console.log("- video convert example:");
	console.log("  mdk video convert mov *.mkv");
};

exports.videoGifify = function () {
	console.log("- video gifify example:");
	console.log("  mdk video gifify *.mp4");
};
